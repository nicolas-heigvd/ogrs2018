...
It uses crowdsourcing for the georeferencing of historical images. 
These images come from several different sources, such as public archives or 
private libraries. 
The georeferencing process consists of picking a minimum of six well identifiable
points both in the image and the textured 3D model of the landscape. 
